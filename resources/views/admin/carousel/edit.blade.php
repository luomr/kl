            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" method="post" action="/admin/carousel/update" class="form-horizontal m-t" id="commentForm">
                          <!--   {{ method_field('PUT') }} -->
                            {!! csrf_field() !!}
                            <div class="form-group">
                                <label class="col-sm-3 control-label"></label>
                                <div class="col-sm-8">
                                    <input id="cname" name="id" minlength="2" type="hidden" class="form-control" required="" aria-required="true" value="{{ $result->id}}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="img" type="file" required="" aria-required="true" value="" style="float:left">
                                    <img src="{{ $result->img}}" alt="" style="margin-left:-60px;width:30px">
                                </div>
                            </div>
                            <div class="form-group">

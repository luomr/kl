...
<body class="gray-bg">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$v->cateid}}</td>
                                    <td>{{$v->attrid}}</td>
                                    <td><a href="/admin/cateattr/{{$v->id}}/edit " title="修改"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="javacript:;" title="删除" onclick="delCat(this,{{$v->id}})"><i class="fa fa-trash-o"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <script>
       ...
       function delCat(obj,id){
            ...
            {btn: ['确定','取消']},
            function(){
             $.post('/admin/cateattr/'+id,{'_method':'delete','_token':'{{csrf_token()}}'},function(data){
               if(data.status==0){

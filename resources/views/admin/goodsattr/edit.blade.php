            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" method="post" action="/admin/goodsattr/{{$result->id}}" class="form-horizontal m-t" id="commentForm">
                        <?php echo method_field('PUT'); ?>
                        <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">属性名称：</label>
                                <div class="col-sm-8">
                                    <input id="cname" name="attrname" minlength="2" type="text" class="form-control" required="" aria-required="true" value="{{ $result->attrname }}">
                                </div>
                            </div>
                            <div class="form-group">

                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" method="post" action="/admin/admin" class="form-horizontal m-t" id="commentForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="cname" name="name" type="text" class="form-control" value="">@if ($errors->has('name')){{ $errors->first('name') }}
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="cemail" type="password" class="form-control" name="password" value="">@if ($errors->has('password')){{ $errors->first('password') }}
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">

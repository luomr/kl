            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" method="post" action="/admin/ad/{{$res->id}}" class="form-horizontal m-t" id="commentForm">
                        <?php echo method_field('PUT'); ?>
                        <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">广告专栏图</label>
                                <div class="col-sm-4">
                                    <input type="file" name="adimg" multiple  value="" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">广告专栏名称：</label>
                                <div class="col-sm-4">
                                    <input id="cname" name="adname" minlength="2" type="text" class="form-control" required="" aria-required="true" value="{{$res->adname}}">
                                </div>
                            </div>
                            <div class="form-group">

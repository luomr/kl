            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>商品广告专栏</h5>
                        <form method="post" action="/admin/ad/search" class="pull-right mail-search" style="margin-top:-6px">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$v->id}}</td>
                                    <td><img src="{{$v->adimg}}" style="height:50px"></td>
                                    <td>{{$v->adname}}</td>
                                    <td><a href="/admin/ad/{{$v->id}}/edit " title="修改"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="javacript:;" title="删除" onclick="delCat(this,{{$v->id}})"><i class="fa fa-trash-o"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>

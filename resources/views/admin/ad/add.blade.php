            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/admin/ad" class="form-horizontal m-t" id="commentForm" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input id="cname" name="adname" minlength="2" type="text" class="form-control" required="" aria-required="true" value="">
                                </div>
                            </div>
                            <div class="form-group">

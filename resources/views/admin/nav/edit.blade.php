            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="/admin/nav/update" method="post" enctype="multipart/form-data" id="commentForm">
                            {!! csrf_field() !!}
                            <input type="" name="id" value="{{$result->id}}" style="display:none;">
                            标题名:<input type="" name="name" value="{{$result->name}}"><br><br>
                            <br><br>
                            链接地址:<input type="" name="link" value="{{$result->link}}"><br><br>
                            <button type="submit" class="btn btn-sm btn-primary">
                                提交
                            </button>
                        </form>

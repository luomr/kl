...
<head>
    ...
    <!-- Morris -->
    <link href="/adminpublic/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <!-- Flot -->
    <script src="/adminpublic/js/plugins/flot/jquery.flot.js"></script>
    <script src="/adminpublic/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/adminpublic/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/adminpublic/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/adminpublic/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/adminpublic/js/plugins/flot/jquery.flot.symbol.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="/adminpublic/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- Jvectormap -->
    <script src="/adminpublic/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/adminpublic/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="/adminpublic/js/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="/adminpublic/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/adminpublic/js/demo/sparkline-demo.js"></script>

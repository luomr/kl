            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form  method="post" action="/admin/goodsinfo" class="form-horizontal m-t" id="commentForm" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <div class="form-group">
                                <label class="col-sm-2 control-label">商品图：</label>
                                <div class="col-sm-4">
                                    <input type="file" name="infoimg[]" multiple  value="" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input id="cname" name="infonum" minlength="2" type="text" class="form-control" required="" aria-required="true" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">商品原价：</label>
                                <div class="col-sm-4">
                                    <input id="cname" name="infoprice" minlength="2" type="text" class="form-control" required="" aria-required="true" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">商品折价：</label>
                                <div class="col-sm-4">
                                    <input id="cname" name="infosale" type="text" class="form-control" required="" aria-required="true" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <script id="editor" type="text/plain" style="width:100%;height:300px;" name="infocontent"></script>

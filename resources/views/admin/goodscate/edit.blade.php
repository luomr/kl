            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/admin/goodscate/{{$field->id}}" class="form-horizontal m-t" id="commentForm">
                            {!! csrf_field() !!}
                            {{method_field('PUT')}}
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <option value="0" @if($field->catepid==0)selected @endif>顶级分类</option>
                                    @foreach($data as $v)
                                    <option value="{{$v->id}}") @if($field->catepid==$v->id)selected @endif>
                                     @if($v->level!==0)|@endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="catename" type="text"  value="{{$field->catename}}">
                                </div>
                            </div>
                            <div class="form-group">

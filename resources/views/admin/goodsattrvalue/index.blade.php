...
<body class="gray-bg">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$v->valuepid}}</td>
                                    <td>{{$v->valueattr}}</td>
                                    <td><a href="/admin/goodsattrvalue/{{$v->id}}/edit " title="修改"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="javascript:;" title="删除" onclick="delVal(this,{{$v->id}})"><i class="fa fa-trash-o"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <script>
        //删除
        function delVal(obj,id){
            layer.confirm('您确定要删除此属性值吗？',
            {btn: ['确定','取消']},
            function(){
             $.post('/admin/goodsattrvalue/'+id,{'_method':'delete','_token':'{{csrf_token()}}'},function(data){
               if(data.status==0){

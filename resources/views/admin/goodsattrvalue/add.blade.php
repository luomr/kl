            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" method="post" action="/admin/goodsattrvalue" class="form-horizontal m-t" id="commentForm">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input id="cname" name="valueattr" minlength="2" type="text" class="form-control" required="" aria-required="true" value="{{ old('valueattr') }}">
                                </div>
                            </div>
                            <div class="form-group">

            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" method="post" action="/admin/goodsattrvalue/{{$result->id}}" class="form-horizontal m-t" id="commentForm">
                        <?php echo method_field('PUT'); ?>
                        <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">分类名称：</label>
                                <div class="col-sm-3">
                                    <select name="valuecate"  required="" aria-required="true" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control m-b" name="valuepid" required="" aria-required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input id="cname" name="valueattr" minlength="2" type="text" class="form-control" required="" aria-required="true" value="{{ $result->valueattr }}">
                                </div>
                            </div>
                            <div class="form-group">
